...
nnoremap <silent> <unique> mm :call Vm_toggle_sign()<cr>
...
nnoremap <silent> <unique> mn :call Vm_goto_next_sign()<cr>
...
nnoremap <silent> <unique> mp :call Vm_goto_prev_sign()<cr>
